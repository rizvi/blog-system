...
import com.mit.du.admin.AdminPages.EditCustomerEmployee.EmployeeInfoEdit;
    ...
    private void editTableRowInfo(AdminEmployeeTable adminEmployeeTable) {
        ...
        try {
            if (!connection.isClosed()) {
                ...
                loader.setLocation(getClass().getResource("/admin/AdminPages/EditCustomerEmployee/EmployeeInfoEdit.fxml"));
