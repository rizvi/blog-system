...
import com.mit.du.admin.AdminPages.EditCustomerEmployee.CustomerInfoEdit;
    ...
    private void editTableRowInfo(AdminCustomerTable adminCustomerTable) {
        ...
        try {
            if (!connection.isClosed()) {
                ...
                loader.setLocation(getClass().getResource("/admin/AdminPages/EditCustomerEmployee/CustomerInfoEdit.fxml"));
