package com.mit.du.blogger.BloggerPages.BloggerInfo;
...
import com.mit.du.blogger.Login.BloggerLogin;
...
public class BloggerInfo implements Initializable {
    ...
    private void setManagerData() {
        ...
        try {
            if(!connection.isClosed()){
                ...
                statement.setString(1, BloggerLogin.currentEmployeeNID);
