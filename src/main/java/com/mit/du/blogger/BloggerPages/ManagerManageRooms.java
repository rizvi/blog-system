...
import com.mit.du.common.tableview.ManagerRoomTable;
import com.mit.du.blogger.BloggerPages.RoomInfoEdit.RoomInfoEdit;
        ...
        if (!(managerRoomTable.getSTATUS()).equals("Booked")) {
            ...
            try {
                if (!connection.isClosed()) {
                    ...
                    loader.setLocation(getClass().getResource("/blogger/BloggerPages/RoomInfoEdit/roomInfoEdit.fxml"));
